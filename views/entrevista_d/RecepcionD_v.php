                    ...
                    <div class="outer" style="height: 1200px;">
                        <div class="inner bg-light lter">
                            <div class="body">                
                                ...
                                <h3>Recepción de formatos de entrevista diagnostica</h3>
                               
                                <hr>



                                    <?= form_open(base_url().'index.php/entrevista_d/RecepcionD_c/Recep',array('name'=>'',
                                                                                                 'id'=>'', 
                                                                                                 'autocomplete' => 'off') );?>
                                    <center>     
                                        <table>
                                    ...
                                    <th>&nbsp;</th>
                                            ...
                                            <tr>
                                                ...
                                                <td><?= form_input('expediente','','class="form-control" onkeypress="return numbertext(event);" maxlength="7" size="5" placeholder="####"');?></td>                    
                                                <td><?= form_input('anioexp','','class="form-control" onkeypress="return textonly(event);" maxlength="5" size="5" placeholder="####"');?></td>
                                                <td><?= form_input('oficio','','class="form-control" onkeypress="return textonly(event);" maxlength="5" size="5" placeholder="####"');?></td>
                                                ...
                                                <td><input type="submit" class="btn btn-primary" id="buscar" name="buscar" value="Buscar" /></td></tr>
