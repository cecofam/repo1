...
<head>
    ...
    <script  defer type="text/javascript" src="<?php echo site_url('scripts/dhtmlgoodies_calendar/dhtmlgoodies_calendar.js')?>"></script>
    <script   type="text/javascript" src="<?php echo site_url('scripts/Entrevista_diag.js')?>"></script>  
    <script   type="text/javascript" src="<?php echo base_url('scripts/Facilitador.js')?>"></script>  
  </head>
        <body class="  ">
                    ...
                    <div class="outer" style="height: 1200px;">
                        <div class="inner bg-light lter">
                            <div class="body">
                                ...
                                <h3>Entrevista Diagnóstica</h3>
                                <hr>
                                <!---Muestra los campos de texto para realizar una búsqueda**************-->
                                 <?= form_open(base_url().'index.php/entrevista_d/Entrevistad_c/Buscar_sol',array('name'=>'Buscarorgano',
                                                                                                 'id'=>'Buscarorgano', 
                                                                                                 'autocomplete' => 'off') );?>     
                               <center>
                                   <table>
                                       <tr>
                                        ...
                                        <tr>
                                            ...
                                            <td><?= form_input('annio_folio','','class="form-control" onkeypress="return textonly(event);" maxlength="5" size="5" placeholder="####"');?></td>
                                            <td><?= form_input('#oficio','','class="form-control" onkeypress="return textonly(event);" maxlength="25" size="25" placeholder="####/####"');?></td> 
                                            <td><?= form_input('expediente','','class="form-control" onkeypress="return textonly(event);" maxlength="5" size="5" placeholder="####"');?></td>
                                            <td><?= form_input('annio_exp','','class="form-control" onkeypress="return textonly(event);" maxlength="5" size="5" placeholder="####"');?></td>
                                            <td><?= form_input('toca','','class="form-control" onkeypress="return textonly(event);" maxlength="5" size="5" placeholder="####"');?></td>
