                    ...
                    <div class="outer" style="height: 1200px;">
                        <div class="inner bg-light lter">
                            <div class="body">
                                ...
                                <!--Realizar Búsqueda de las personas-->
                                <h3>Informe de la Entrevista Diagnóstica.</h3>
                                <hr>
                                 <?= form_open(base_url().'index.php/entrevista_d/InformeED_c/bus_Solictud',
                                                                                            array('name'=>'Buscar',
                                                                                                 'id'=>'Buscar', 
                                                                                                 'autocomplete' => 'off') );?>
                                <center>
                                    <table>
                                        ...
                                        <tr>                           
                                            ...
                                            <td><?= form_input('anioexp','','class="form-control" onkeypress="return numberText(event);" maxlength="4" size="5" placeholder="####"');?></td>
                                            <td><?= form_input('folio','','class="form-control" onkeypress="return numberText(event);" maxlength="6" size="5" placeholder="####"');?></td>
                                            <td><?= form_input('aniofol','','class="form-control" onkeypress="return numberText(event);" maxlength="4" size="5" placeholder="####"');?></td>
                                            <td><?= form_input('oficio','','class="form-control" onkeypress="return numberText(event);" maxlength="6" size="15" placeholder="####/####"');?></td>
                                            <td><?= form_input('toca','','class="form-control" onkeypress="return numberText(event);" maxlength="5" size="5" placeholder="####"');?></td> 
                                            <td>&nbsp;&nbsp;&nbsp;<input type="submit" class="btn btn-primary" id="buscar" name="buscar" value="Buscar"><td>
                                ...
                                <!--Turnar al Sistema-->
                                <!--<?= form_open(base_url().'index.php/rec_oficios/rec_oficios_c/receSol',
                                                                                            array('name'=>'Turnar',
                                                                                                 'id'=>'Turnar', 
                                                                                                 'autocomplete' => 'off') );?>
                                <hr><br><div align="center">
                                    <input type="submit" class="btn btn-primary" id="turnar" name="turnar" value="Turnar al Sistema"><td>
                                </div>    
                        ...
                        <!--Deseleccionar y Seleccionar los radiobutton -->    
