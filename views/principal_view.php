        ...
        <body class="  ">
            <div class="bg-dark dk" id="wrap">
                ...
                <!-- /#top -->
                    ...
                    <!-- /#left -->
                <div id="content">
                    <div class="outer" style="overflow: scroll;margin-left: 15%">
                        <div class="inner bg-light lter" style="height: 800px;">
                            <div class="col-lg-12">
                                <center>
                                    <h1>Bienvenido al Sistema de Convivencia Familiar Supervisada 
                                    para la Re-vinculación Familiar</h1>
                                </center>    
                            </div>
                        </div>
                        <!-- /.inner -->
