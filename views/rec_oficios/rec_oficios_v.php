                    ...
                    <div class="outer" style="height: 1200px;">
                        <div class="inner bg-light lter">
                            <div class="body">
                                ...
                                <h3>Recepción de oficios</h3>
                                <hr>
                                 <?= form_open(base_url().'index.php/rec_oficios/rec_oficios_c/bus_Solictud',
                                                                                            array('name'=>'Buscar',
                                                                                                 'id'=>'Buscar', 
                                                                                                 'autocomplete' => 'off') );?>
                                <center>
                                    <table>
                                        ...
                                        <tr>                           
                                            ...
                                            <td><?= form_input('anioexp','','class="form-control" onkeypress="return numberText(event);" maxlength="5" size="5" placeholder="####"');?></td>                                                                                                                          
                                ...
                                <div>
                                    ...
                                    <br>             
                                        <div align="center">
                                            <a href="<?php echo base_url().'index.php/solicitud/Solicitud';?>" >
                                                Oficio no encontrado (Ingresar información contenida en el oficio al sistema).
                                            </a>
                                        </div>
                                        <div align="right">
